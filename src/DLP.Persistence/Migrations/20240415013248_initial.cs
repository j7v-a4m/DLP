        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutMe = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutCourse = table.Column<string>(type: "text", nullable: true),
                    WhatYouWillLearn = table.Column<string[]>(type: "text[]", nullable: true),
                    InitialRequirements = table.Column<string[]>(type: "text[]", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscriptions", x => new { x.StudentId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Title = table.Column<string>(type: "text", nullable: false),
                    LessonUrl = table.Column<string>(type: "text", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    ResourcesUrl = table.Column<string>(type: "text", nullable: true),
